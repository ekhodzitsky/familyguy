...
<div class="uk-container uk-container-expand">
    ...
    <div class="uk-section uk-padding uk-width-1-2 uk-align-center">
        <div class="uk-container">
            <form action="/admin/remove_comment_by_id" method="post">
                <fieldset class="uk-fieldset">
                    <legend class="uk-legend">Удалить пользователя</legend>

                    <div class="uk-margin">
                        <input class="uk-input uk-form-small" type="text" placeholder="Id видео..." name="videoID">
                    </div>

                    <div class="uk-margin">
                        <input class="uk-input uk-form-small" type="text" placeholder="Id коммента..." name="commentID">
                    </div>
