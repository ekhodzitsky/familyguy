...
<#import "../../blocks/common/translations_list.ftl" as tl>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Гриффины | Удалить перевод</title>
    <@h.adm_head/>
</head>
<body>
<@a.adm_nav/>
<div class="uk-container uk-container-expand">
    ...
    <div class="uk-section uk-padding uk-width-1-2 uk-align-center">
        <div class="uk-container">
            <form action="/admin/video_remove_translation" method="post">
                <fieldset class="uk-fieldset">
                    <legend class="uk-legend">Удалить перевод</legend>
